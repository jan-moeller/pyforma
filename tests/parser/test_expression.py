                                                    ...
                                                    ParseFailure(
                                                        ...
                                                        cause=ParseResult(
                                                            ParseFailure(
                                                                ...
                                                                cause=ParseResult(
                                                                    ParseFailure(
                                                                        expected='sequence(alternation("not"), whitespace, unary-expression("not"))',
                                                                        cause=ParseResult(
                                                                            ParseFailure(
                                                                                expected='alternation("not")',
                                                                                cause=ParseResult(
                                                                                    ParseFailure(
                                                                                        expected='"not"',
                                                                                        cause=ParseResult(
                                                            ...
                                                            ParseFailure(
                                                                ...
                                                                cause=ParseResult(
                                                                    ParseFailure(
                                                                        ...
                                                                        cause=ParseResult(
                                                                            ParseFailure(
                                                                                expected='sequence(binary-expression("in", "not in"), repetition(sequence(whitespace, alternation("==", "!=", "<=", "<", ">=", ">"), whitespace, binary-expression("in", "not in"))))',
                                                                                cause=ParseResult(
                                                                                    ParseFailure(
                                                                                        expected='binary-expression("in", "not in")',
                                                                                        cause=ParseResult(
                                                                                            ParseFailure(
                                                                                                expected='sequence(binary-expression("|"), repetition(sequence(whitespace, alternation("in", "not in"), whitespace, binary-expression("|"))))',
                                                                                                cause=ParseResult(
                                                                                                    ParseFailure(
                                                                                                        expected='binary-expression("|")',
                                                                                                        cause=ParseResult(
                                                                                                            ParseFailure(
                                                                                                                expected='sequence(binary-expression("^"), repetition(sequence(whitespace, alternation("|"), whitespace, binary-expression("^"))))',
                                                                                                                cause=ParseResult(
                                                                                                                    ParseFailure(
                                                                                                                        expected='binary-expression("^")',
                                                                                                                        cause=ParseResult(
                                                                                                                                                                            ...
                                                                                                                                                                            ParseFailure(
                                                                                                                                                                                ...
                                                                                                                                                                                cause=ParseResult(
                                                                                                                                                                                    ParseFailure(
                                                                                                                                                                                        ...
                                                                                                                                                                                        cause=ParseResult(
                                                                                                                                                                                            ParseFailure(
                                                                                                                                                                                                expected='sequence(unary-expression("+", "-", "~"), repetition(sequence(whitespace, alternation("*", "//", "/", "%", "@"), whitespace, unary-expression("+", "-", "~"))))',
                                                                                                                                                                                                cause=ParseResult(
                                                                                                                                                                                                    ParseFailure(
                                                                                                                                                                                                        expected='unary-expression("+", "-", "~")',
                                                                                                                                                                                                        cause=ParseResult(
                                                                                                                                                                                                            ParseFailure(
                                                                                                                                                                                                                expected='alternation(sequence(alternation("+", "-", "~"), whitespace, unary-expression("+", "-", "~")), binary-expression("**"))',
                                                                                                                                                                                                                cause=ParseResult(
                                                                                                                                                                                                                    ParseFailure(
                                                                                                                                                                                                                        expected='binary-expression("**")',
                                                                                                                                                                                                                        cause=ParseResult(
                                                                                                                                                                                                                            ParseFailure(
                                                                                                                                                                                                                                expected='sequence(transform(transform_success(primary-expression, <lambda>), _transform_primary_expression), repetition(sequence(whitespace, alternation("**"), whitespace, transform(transform_success(primary-expression, <lambda>), _transform_primary_expression))))',
                                                                                                                                                                                                                                cause=ParseResult(
                                                                                                                                                                                                                                    ParseFailure(
                                                                                                                                                                                                                                        expected="transform(transform_success(primary-expression, <lambda>), _transform_primary_expression)",
                                                                                                                                                                                                                                        cause=ParseResult(
                                                                                                                                                                                                                                            ParseFailure(
